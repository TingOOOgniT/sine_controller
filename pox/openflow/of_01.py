...
from pox.sine import Collect_serInfo
...
def handle_HELLO (con, msg): #S
  ...
  #con.raiseEventNoErrors(SINEIn, con, msg)
...
def handle_FEATURES_REPLY (con, msg):
  print "DJ---/pox/openflow/of_01.py handle_FEATURES_REPLY!"
  ...
  def finish_connecting (event):
    print "DJ---/pox/openflow/of_01.py handle_BarrierIn!"
    con.raiseEventNoErrors(SINEIn, con, msg)
...
def handle_PACKET_IN (con, msg): #A
  print "DJ---/pox/openflow/of_01.py handle_PACKET_IN! argument:con=",con
...
class OpenFlow_01_Task (Task):
  ...
  def _handle_GoingUpEvent (self, event):
    print "DJ---/pox/openflow/of_01.py class OpenFlow_01_Task _handle_GoingUpEvent!"
    self.start()

  def run (self):
    print "DJ---/pox/openflow/of_01.py class OpenFlow_01_Task run!"
