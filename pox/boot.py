...
#DJ++ 20131216
import pox.sine
import pox.sine.libsine
import pox.sine.libinfo #DJ++ 20131225
...
def _post_startup ():
  if _options.enable_openflow:
    ...
    pox.sine.libsine.launch() #DJ++20131218
    #pox.forwarding.l3_learning.launch() #DJ++20131218
    pox.sine.libinfo.launch() #DJ++20131225
